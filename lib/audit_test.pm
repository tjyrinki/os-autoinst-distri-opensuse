...
our $default_code_base = get_var('IPSEC_TEST') ? 'https://gitlab.suse.de/qe-security/ipsec/-/archive/main/ipsec-main.tar' : 'https://gitlab.suse.de/security/audit-test-sle15/-/archive/timo/issue_2_adduser_changed/audit-test-sle15-timo-issue_2_adduser_changed.tar';
